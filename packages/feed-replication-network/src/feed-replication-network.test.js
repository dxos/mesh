...
import { FeedReplicationPeerFactory } from './feed-replication-peer';
...
test('DirectedReplicationNetwork', async () => {
  ...
  const network = await createDirectedReplicationNetwork({ initializeConnected: false, peerCount: 2 }, FeedReplicationPeerFactory);
